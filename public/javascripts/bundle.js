...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.evaluation-button').each(function (i, e) {
  ...
  button.click(function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.post("/fixtures/".concat(fixtureId, "/post/").concat(postId, "/users/").concat(userId), {
      evaluation: evaluation
    }, function (data) {
      button.attr('data-user-evaluation', data.evaluation);
      var nowGoodSum = parseInt(button.prev().text()); //jQuery、ボタンの前のテキスト（いいね総数）を取得
